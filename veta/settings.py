"""
Django settings for veta project.
...
SECRET_KEY = 'django-insecure-vxu-l60d^+u5j-xtuwtz=9nglag)x2gmxsqd_aqd3ah&k0mc*f'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'alertas.context_processors.alertas_globales',
            ],
        },
    },
]

WSGI_APPLICATION = 'veta.wsgi.application'
